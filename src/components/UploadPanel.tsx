    ...
    <section className="glass rise rounded-[28px] p-2">
      <div
        ...
        className={`group relative cursor-pointer rounded-[22px] border border-dashed px-8 py-10 text-center transition-all duration-500 ${
          dragging
            ? 'border-[rgba(255,210,122,0.95)] bg-[rgba(255,210,122,0.07)]'
            : 'border-white/75 hover:border-white hover:bg-white/[0.04]'
      ...
      <div className="px-6 pt-6 pb-5">
        <div className="grid gap-5">
          <div>
            ...
            <div className="inline-flex rounded-full border border-white/70 bg-white/[0.04] p-1">
              {MODES.map((m) => (
                <button
                  key={m.id}
                  type="button"
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-5 rounded-full border border-white/70 bg-white/[0.04] px-5 py-1.5">
              <button
                type="button"
        ...
        <button
          ...
          className={`relative mt-6 w-full overflow-hidden rounded-full py-3.5 text-[12px] tracking-widest uppercase transition-all duration-500 ${
            ready && !ageBlocked
              ...
              : 'cursor-not-allowed border border-white/60 bg-white/[0.04] font-light text-white/60'
          }`}
        >
